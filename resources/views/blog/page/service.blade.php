  ...
  <div class="col-lg-5">
    <div class="text-center">
      <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="250" height="250"
        viewBox="0 0 634.38742 584.34971" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#e6e6e6" />
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#ccc" />
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#3f3d56" />
        <path d="M475.26725,320.82514h-159a8,8,0,1,1,0-16h159a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#f2f2f2" />
        <path d="M475.26725,354.82514h-159a8,8,0,1,1,0-16h159a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#ccc" />
        <path d="M475.26725,388.82514h-159a8,8,0,1,1,0-16h159a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#ccc" />
        <path d="M487.26725,422.82514h-159a8,8,0,1,1,0-16h159a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#ccc" />
        <path d="M487.26725,456.82514h-159a8,8,0,1,1,0-16h159a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#ccc" />
        <path d="M391.26725,286.82514h-75a8,8,0,1,1,0-16h75a8,8,0,0,1,0,16Z"
          transform="translate(-282.80629 -157.82514)" fill="#f2f2f2" />
        <path
        ...
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#fff" />
        <path
        ...
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#ffb8b8" />
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#f2f2f2" />
        <polygon points="373.17 572.064 360.911 572.064 355.078 524.776 373.173 524.777 373.17 572.064"
          fill="#ffb8b8" />
        <path
          ...
          fill="#2f2e41" />
        <polygon points="414.17 571.064 401.911 571.064 396.078 523.776 414.173 523.777 414.17 571.064"
          fill="#ffb8b8" />
        <path
        ...
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#2f2e41" />
        ...
        <path
          ...
          transform="translate(-282.80629 -157.82514)" fill="#2f2e41" />
        <path d="M535.19371,741.82514h381a1,1,0,0,0,0-2h-381a1,1,0,0,0,0,2Z"
          transform="translate(-282.80629 -157.82514)" fill="#3f3d56" />
      </svg>
      <span class="display-5 d-flex justify-content-center text-muted">Pelayanan Publik</span>
    </div>
  </div>
  <div class="col-lg-7">
    <div class="row mb-2">
      <label for="jenis_layanan">Jenis Pelayanan</label>
      <div class="col-sm-12">
        ...
        <a href="{{ route('service.show') }}" class="btn btn-sm btn-outline-secondary mt-2" id="reset_button"><i
    ...
    <div class="card shadow-sm mb-3 d-none" id="permohonan_baru_card">
      ...
      <div class="card-body">
        <form action="{{ route('createNewApplicant') }}" method="POST" enctype="multipart/form-data"
          id="applicantForm">
          @csrf
          <div class="row mb-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <select class="form-select @error('layanan')
                is-invalid
              @enderror"
                id="layanan" name="layanan" data-old="{{ old('layanan') }}" data-placeholder="Pilih Layanan">
          ...
          <div class="row mb-3 d-none" id="file_pendukung">
            ...
            <div class="col-md-3 mx-auto col-4 text-center" id="file_sop">
              <a href="#" target="_blank"><img src="{{ asset('img/download.png') }}" alt=""
          ...
          <input type="hidden" id="is_file_persyaratan_required" name="is_file_persyaratan_required"
            value="0">
          <button type="submit" id="spin" class="btn btn-sm btn-primary"><i class="bi bi-send"></i>
            Kirim</button>
        </form>
      </div>
    </div>
...
@push('scripts')
  <script>
    ...
    $(document).on('click', '#detail_permohonan', function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#modalListId').text(response.list.judul);
          $('#modalServiceId').text(response.service.judul);
          ...
          if (response.status == 'selesai') {
            ...
            // Clear the rating component if not 'selesai'
            $('#modalRating').html('-');
          }
        }
      });
    ...
    function renderRatingComponent(rating) {
      $('#rating').empty();
      const Component = function() {
        ...
        self.change = (newValue) => {
          ...
          $.ajax({
            ...
            data: {
              _token: '{{ csrf_token() }}',
              kode_layanan: $('#modalKodeLayanan').text(),
              rating: newValue
            },
            success: function() {
              Swal.fire({
                ...
                // Update the component to show the new rating as text
                $('#rating').html('<p>Anda memberi rating bintang ' + newValue + '</p>');
              });
            },
            error: function() {
              Swal.fire('Gagal!', 'Gagal menyimpan rating.', 'error');
            }
          });
        }
      ...
      // Render the rating component
      lemonade.render(Component, document.getElementById('rating'));
    }
  </script>
  <script>
