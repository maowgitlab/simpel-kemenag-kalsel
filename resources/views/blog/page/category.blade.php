  ...
  <div class="d-md-flex post-entry-2 half">
    ...
    <div>
      <div class="post-meta"><span class="date">{{ $media->category->nama_kategori }}</span> <span
          class="mx-1">•</span> <span>{{ $media->created_at->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</span>
      </div>
      ...
      <div class="photo"><img src="{{ $media->user->avatar == 'user.png' ? asset('img/user.png') : asset('storage/' . $media->user->avatar) }}" alt="" class="img-fluid"></div>
        <div class="name">
...
@empty
  <div class="text-center" style="margin: 5rem 0">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="150" height="150"
      ...
      <path
        ...
        transform="translate(-276.18187 -133.91309)" fill="#f2f2f2" />
      <circle cx="190.15351" cy="24.95465" r="20" fill="#f2f2f2" />
      ...
      <path
        ...
        transform="translate(-276.18187 -133.91309)" fill="#f2f2f2" />
      <circle cx="433.63626" cy="105.17383" r="20" fill="#f2f2f2" />
      <circle cx="433.63626" cy="105.17383" r="12.18187" fill="#fff" />
    </svg>
    <span class="display-5 d-flex justify-content-center text-muted">Data Tidak Ditemukan</span>
  </div>
@endforelse
{{ $medias->links('blog.vendor.pagnation.custom') }}
